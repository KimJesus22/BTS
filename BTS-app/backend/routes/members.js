...
router.get('/', optionalAuth, MembersController.getMembers);
router.get('/search', optionalAuth, MembersController.searchMembers);
...
router.get('/:id', optionalAuth, MembersController.getMemberById);
